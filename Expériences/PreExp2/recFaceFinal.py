...
class Recognize():
    ...
    def detectOnPict(self):
		...
		frame = cv2.imread('imagesExp/pic'+str(i)+'.png')
		...
		for f in facePos: 
		    ...
		    if confidence > SEUIL:
		        identity = "INCONNU"
		    print('Eigenface detecte : ' + identity)
		...
		for f in facePos: 
		    ...
		    if confidence > SEUIL:
		        identity = "INCONNU"
		    print('Fisherface detecte : ' + identity)
