...
\begin{figure}[h]
	...
	\end{center}
\end{figure}
Par ailleurs, la d\'etection des couleurs //--INSERER CODE COULEUR + LIEN-// a donn\'e de bien meilleurs r\'esultats (Figure \ref{fig:inRangeOk}).\\
\begin{figure}[h]
	\begin{center}
