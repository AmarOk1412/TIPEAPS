...
Vous pouvez retrouver plus de détails dans la documentation d'OpenCV (\cite{docOpenCVFisherFace} et \cite{docOpenCVFaceRecognizer})
...
\cite{photorealisticExpressiveTextTalkingHeadSynthesis}<- je vois pas ou le caser, c'est plus simuler expression... Ph -> \cite{essentielSecuriteRoutiere} \cite{analyseQuantificationComportementsConducteursAutomobilesPreCrash}
% /test
