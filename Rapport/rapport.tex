...
$\frac{1}{n}\times\sum_{i=1}^{n} x_i$ avec $x_0, x_1, ..., x_n$ les images de la classe.\\
Puis, on calcule les matrice de dispersion intra et inter classe (disons respectivement $M_i$ et $M_e$).\\
